            ...
            {isAuthenticated ?
                (<>
                    <CopyToClipboard text={roomid} onCopy={() => showtoast()}>
                        <button className="copyclipboarddiv copyclipboarddiv2 bg-gray-700 px-0 w-96 pr-0 py-2 text-sm md:absolute md:z-50   text-white mt-2 flex items-center justify-center outline-none border-none rounded-tl-lg " >
                            <span className="px-2">
                    ...
                    <div className="onlinediv onlinediv2 h-96 bg-white w-52  absolute  right-1 top-20  rounded-tr-lg rounded-br-lg overflow-y-scroll border-l-2 border-gray-300  z-10 hidden">
                        {
                            users.map((user) => (
                    ...
                    <form className="input-text input-text2" onSubmit={(e) => sendmessage(e)}>
